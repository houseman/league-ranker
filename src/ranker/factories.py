...
class LogTableFactory:
    ...
    def __init__(self) -> None:
        self.points_win = LeagueRankerConfiguration().get_int("points_win") or 3
        self.points_loss = LeagueRankerConfiguration().get_int("points_loss") or 0
        self.points_draw = LeagueRankerConfiguration().get_int("points_draw") or 1
